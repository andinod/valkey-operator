...
# andino.io/valkey-bundle:$VERSION and andino.io/valkey-catalog:$VERSION.
IMAGE_TAG_BASE ?= andino.io/valkey
...
helm: kustomize helmify
	$(KUSTOMIZE) build config/default | $(HELMIFY) charts/valkey-operator
